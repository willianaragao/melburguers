  ...
  return (
    <div className="app-container">
      ...
      <header className="insta-header">
        <div className="profile-top">
          ...
          <div className="profile-title-area">
            ...
            <div className="display-name">Mel Burger's ­ƒìö</div>
      ...
      <footer style={{ padding: '0 20px 120px', textAlign: 'center', opacity: 0.6, fontSize: '13px' }}>
        <p>Aberto das 19h ├ás 1h</p>
        <p>Desenvolvido com ÔØñ´©Å para Mel Burgers</p>
      </footer>
          ...
          >
            ...
            >
              <div className="modal-header">
                ...
                <h3>Seu Carrinho</h3>
                <button className="close-modal" onClick={() => setIsCartOpen(false)}>├ù</button>
              </div>
